...
<title>Coocurrence matrix. — coocur • netCoin</title>
...
<meta property="og:title" content="Coocurrence matrix. — coocur" />
<meta property="og:description" content="A coocurrence object consists of a matrix with the number of ocurrences in its main diagonal and the number of coocurrences outside this diagonal.
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <h1>Coocurrence matrix.</h1>
    
    <div class="hidden name"><code>coocur.rd</code></div>
    </div>

    <div class="ref-description">
    <p>A coocurrence object consists of a matrix with the number of ocurrences in its main diagonal and the number of coocurrences outside this diagonal.
Besides, this object has two attributes: 1) n is the total of the sum of the ocurrences in each row.2) m is the sum of the maximum number of ocurrences in each row.</p>
    ...
    <tr>
      <th>ocurrences</th>
      <td><p>an ocurrence matrix or data frame</p></td>
    </tr>
    <tr>
      <th>minimum</th>
      <td><p>minimum frequency to be considered</p></td>
    </tr>
    <tr>
      <th>maximum</th>
      <td><p>maximum frequency to be considered</p></td>
    </tr>
    <tr>
      <th>sort</th>
      <td><p>sort the coincidence matrix according to frequency of events</p></td>
    </tr>
    <tr>
      <th>decreasing</th>
      <td><p>decreasing or increasing sort of the matrix</p></td>
    </tr>
    </table>

    <h2 class="hasAnchor" id="details"><a class="anchor" href="#details"></a>Details</h2>

    <p>Produce a matrix of coocurrences from a matrix of occurences.</p>
    <h2 class="hasAnchor" id="value"><a class="anchor" href="#value"></a>Value</h2>

    <p>An object of <code>cooc</code> class with a coocurrence matrix. It has two attributes:</p>
